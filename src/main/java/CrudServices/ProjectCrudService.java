...
public class ProjectCrudService {
    ...
    static {
        try {
            updateSt = connection
                    .prepareStatement("UPDATE project SET project.name = ?, project.time_of_creation = ?," +
                            " project.customer_id= ?, project.company_id =? WHERE project.id = ?");
        } catch (SQLException e) {
            throw new RuntimeException(e);
        }
    }
    ...
    public static int create(Project project) throws SQLException {
        ...
        createSt.setLong(3, project.getCustomer());
        createSt.setLong(4, project.getCompany());
        return createSt.executeUpdate();

    }

    public static Project getById(long id) throws SQLException {
        readSt.setLong(1, id);
    ...
    public static int updateProject(Project project) throws SQLException {
        ...
        updateSt.setLong(3, project.getCustomer());
        updateSt.setLong(4, project.getCompany());
